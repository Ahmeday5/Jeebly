...
@Component({
  selector: 'app-add-basic-campaign',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './add-basic-campaign.component.html',
  styleUrl: './add-basic-campaign.component.scss',
})
export class AddBasicCampaignComponent {
