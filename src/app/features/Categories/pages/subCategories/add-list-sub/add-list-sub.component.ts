...
import { MainCategory, SubCategory } from '../../../model/categories.type';
...
export class AddListSubComponent {
  ...
  constructor(
    private apiService: SubCategoriesService,
  ...
  editSubCategory(subCategoryId: number) {
    ...
    this.router.navigate(['Categories/update-subcategory', subCategoryId]);
  }
}
