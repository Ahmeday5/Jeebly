...
@Component({
  selector: 'app-setting-up-car-types',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './setting-up-car-types.component.html',
  styleUrl: './setting-up-car-types.component.scss',
})
export class SettingUpCarTypesComponent {
